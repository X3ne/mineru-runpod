...
The main reason to pick `zip` is drop-in compatibility with the official MinerU cloud API's `full_zip_url` — the [`MineruApiClient`](/mineru-runpod/getting-started/migrate-from-mineru-api/) sets it for you.
