...
This is how the [5,039-page batching run](/mineru-runpod/blog/2026-06-03-clause-aligned-batching-large-pdf-mineru/) hit 3× throughput: `workers_max=3`, `MINERU_MAX_CONCURRENCY=1`, 36 page-range jobs fanned across three 24 GB workers.
