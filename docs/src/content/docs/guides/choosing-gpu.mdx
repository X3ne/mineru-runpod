...
- **The [20 MB response cap](/mineru-runpod/blog/2026-05-20-runpod-20mb-response-cap-r2-bridge/)** — a few hundred pages of output already blows past it.
...
It parses one page range per job; splitting a large document into batches is something *you* do on the client. The full walkthrough — clause-aligned boundaries, R2 transport for huge output, and the throughput math — is in [Clause-aligned batching for large PDFs](/mineru-runpod/blog/2026-06-03-clause-aligned-batching-large-pdf-mineru/), where a **5,039-page** standard parsed on a 24 GB A5000 for ~$1.15.
:::
