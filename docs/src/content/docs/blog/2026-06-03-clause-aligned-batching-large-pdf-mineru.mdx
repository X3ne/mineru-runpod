...
- **The 20 MB response cap.** MinerU's output for a few hundred pages already blows past [RunPod's ~20 MB sync-response ceiling](/mineru-runpod/blog/2026-05-20-runpod-20mb-response-cap-r2-bridge/). For 5,000 pages it isn't close: the extracted output here was **869 MB on disk**.
