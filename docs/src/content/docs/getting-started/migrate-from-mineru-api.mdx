...
Compare the two `full.md` outputs side by side; pair this with the [cost math in the launch post](/mineru-runpod/blog/2026-05-19-launching-mineru-runpod/) to estimate $/page for your volume.
